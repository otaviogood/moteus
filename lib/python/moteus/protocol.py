...
class Register(enum.IntEnum):
    ...
    # Fork-specific (not in upstream mjbots/moteus).  Kept below 0x80
    # so the register number encodes as a single varuint byte.  These
    # were 0x072-0x074 before upstream claimed that range.
    AUX2_QUATERNIONX = 0x06d
    AUX2_QUATERNIONY = 0x06e
    AUX2_QUATERNIONZ = 0x06f

    MILLISECOND_COUNTER = 0x070
    CLOCK_TRIM = 0x071

    AUX1_PWM_INPUT_PERIOD = 0x072
    AUX1_PWM_INPUT_DUTY_CYCLE = 0x073
    AUX2_PWM_INPUT_PERIOD = 0x074
    AUX2_PWM_INPUT_DUTY_CYCLE = 0x075
